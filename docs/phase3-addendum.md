...
export interface EncryptedData { iv: string; ciphertext: string; authTag: string; }
...
export interface SanitizeResult { sanitized: string; injectionDetected: boolean; patternsFound: string[]; }
